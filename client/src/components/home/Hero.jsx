  ...
  return (
    <>
            <div className="min-h-screen pb-20">
                {/* Navbar */}
                    <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-base font-medium">                     <a href="https://prebuiltui.com">
                    ...
                    <div className="flex gap-2">
                        <Link to='/app?state=register' className="hidden md:block px-6 py-2 bg-green-500 hover:bg-green-600 active:scale-95 transition-all rounded-full text-white" hidden={user}>
                            Get started
                        </Link>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    {/* Headline + CTA */}
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 leading-tight md:leading-[1.15]">
                        Land your dream job with <span className=" text-green-600 text-nowrap">AI-powered </span> resumes.
                    </h1>

                    <p className="max-w-xl text-center text-base md:text-lg my-7 text-slate-800">Create, edit and download professional resumes with <br className="hidden md:block"/> AI-powered assistance.</p>
                    ...
                    <p className="py-6 text-slate-600 mt-10">A Full-Stack AI-Powered Resume platform using cutting-edge technology</p>

                   <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 max-w-4xl w-full mx-auto pb-10 text-slate-600 text-sm md:text-base font-normal">
    {focusAreas.map((area, index) => (
        <div key={index} className="flex items-center gap-2">
            {/* Shrunk the SVG width and height from 22 to 18 */}
