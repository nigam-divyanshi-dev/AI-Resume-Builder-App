...
import { ArrowLeft , User, GraduationCap, FolderIcon, Sparkles, DownloadIcon, FileText, Briefcase, Share2Icon, EyeOffIcon, EyeIcon} from 'lucide-react'
  ...
  const downloadResume = ()=>{
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Link to={'/app'} className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-700 transition-colors">
